...
namespace APICustomer.Controllers
{
    ...
    {
        private readonly APICustomer_ProjContext _context;

        public CustomersController(APICustomer_ProjContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Customer>> PostCustomer(Customer customer)
        {
          if (_context.Customer == null)
          {
              return Problem("Entity set 'APICustomer_ProjContext.Customer'  is null.");
          }
