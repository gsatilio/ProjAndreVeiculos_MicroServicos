...
namespace APIBank_SendMessage.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class BanksController : ControllerBase
    {
        private readonly APIBank_SendMessageMongo _context;
        private readonly BankSendMessageMongoService _service;

        public BanksController(APIBank_SendMessageMongo context, BankSendMessageMongoService bankSendMessageService)
        {
            _context = context;
            _service = bankSendMessageService;
        }
        ...
        public async Task<ActionResult<Bank>> PostBank(Bank bank)
        {
          if (_context.Bank == null)
          {
              return Problem("Entity set 'APIBank_SendMessageContext.Bank'  is null.");
          }
