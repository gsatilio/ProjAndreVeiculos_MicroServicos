...
namespace APIBank_Mongo.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class BanksController : ControllerBase
    {
        private readonly APIBank_MongoContext _context;
        private readonly BanksMongoService _service;

        public BanksController(APIBank_MongoContext context, BanksMongoService banksMongoService)
        {
            _context = context;
            _service = banksMongoService;
        }
        ...
        public async Task<ActionResult<Bank>> PostBank(Bank bank)
        {
          if (_context.Bank == null)
          {
              return Problem("Entity set 'APIBank_MongoContext.Bank'  is null.");
          }
